          ...
          <div className="row">
            <div className="col-md-3">
              <ul className="menu-tab">
                <li className="active">
                  <h6 className="fs-16">Swap</h6>
                </li>
                <li>
                  <h6 className="fs-16">Liquidity</h6>
                </li>
                <li>
                  <h6 className="fs-16">Bridge</h6>
                </li>
                <li>
                  <h6 className="fs-16">Stake</h6>
                </li>
              </ul>
            </div>
              ...
              <div className="content-tab">
                  ...
                  <div className="main">
                    ...
                    <form action="" className="form">
                      <div className="form-field">
                        <label>BNB</label>
                        <input type="number" className="dollar" placeholder="" />
                      </div>
                      ...
                      <div className="form-field">
                        <label>VOZ</label>
                        <input type="number" className="bitcoin" placeholder="VOZ" />
                      </div>
                ...
                <div className="content-inner buy-crypto__main">
                  <div className="main">
                    ...
                    <p className="liq-p mt-10">Connect to a wallet to view your liquidity.</p>
                    <button type="submit" className="btn-action w-100 mt-10">
                      + Add Liquidity
                    </button>
                    <div className="button"></div>
                  </div>
                ...
                <div className="content-inner buy-crypto__main">
                  ...
                  <div className="main">
                    ...
                    <form action="https://surielementor.com/rockiehtml/buy-crypto-confirm.html" className="form">
                      <div className="form-field">
                        <label>Pay</label>
