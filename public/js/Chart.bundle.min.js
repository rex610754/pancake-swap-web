...
!(function (t, e) {
      ...
      (a.rgb.hsl = function (t) {
        ...
        (a.rgb.ansi256 = function (t) {
          ...
          return e === n && n === i
            ...
            : 16 + 36 * Math.round((e / 255) * 5) + 6 * Math.round((n / 255) * 5) + Math.round((i / 255) * 5);
        }),
        ...
        (a.ansi256.rgb = function (t) {
          ...
          var n;
          return (
            (t -= 16), [(Math.floor(t / 36) / 5) * 255, (Math.floor((n = t % 36) / 6) / 5) * 255, ((n % 6) / 5) * 255]
          );
        }),
        ...
        (a.rgb.hcg = function (t) {
          var e,
            ...
            s = r - o;
          return (
            (e = s <= 0 ? 0 : r === n ? ((i - a) / s) % 6 : r === i ? 2 + (a - n) / s : 4 + (n - i) / s + 4),
            (e /= 6),
        ...
        (a.hsl.hcg = function (t) {
          var e = t[1] / 100,
            ...
            a = 0;
          return (
            (i = n < 0.5 ? 2 * e * n : 2 * e * (1 - n)) < 1 && (a = (n - 0.5 * i) / (1 - i)), [t[0], 100 * i, 100 * a]
          );
        }),
  ...
  function o(t, e) {
    for (var n = [e[t].parent, t], a = i[e[t].parent][t], o = e[t].parent; e[o].parent; )
  ...
  function h(t) {
    if (t) {
      ...
      if (i) {
        ...
        (i = t.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i))
      ) {
    ...
    S = {
      ...
      merge: function (t, e, n) {
        ...
        for (i = (n = n || {}).merger || S._merger, a = 0; a < u; ++a)
          if (((e = l[a]), S.isObject(e))) for (s = 0, o = (r = Object.keys(e)).length; s < o; ++s) i(r[s], t, e, n);
        return t;
      },
    ...
    R = {
      ...
      roundedRect: function (t, e, n, i, a, r) {
        if (r) {
          ...
          t.moveTo(e, l),
            s < u && l < d
              ? (t.arc(s, l, o, -T, -F), t.arc(u, l, o, -F, 0), t.arc(u, d, o, 0, F), t.arc(s, d, o, F, T))
              : s < u
              ? (t.moveTo(s, n), t.arc(u, l, o, -F, F), t.arc(s, l, o, F, T + F))
              : l < d
  ...
  var B = D,
    ...
    Z = {
      ...
      overrideTextDirection: function (t, e) {
        var n, i;
        ('ltr' !== e && 'rtl' !== e) ||
          ((i = [(n = t.canvas.style).getPropertyValue('direction'), n.getPropertyPriority('direction')]),
  ...
  var Q = {
      ...
      addAnimation: function (t, e, n, i) {
        var a,
          ...
          o = this.animations;
        for (
          e.chart = t, e.startTime = Date.now(), e.duration = n, i || (t.animating = !0), a = 0, r = o.length;
          a < r;
          ++a
        )
      ...
      advance: function () {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            t.currentStep >= n ? (B.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(r, 1)) : ++r;
      }
    },
  ...
  B.extend(it.prototype, {
    ...
    _resolveDatasetElementOptions: function (t, e) {
      ...
      for (n = 0, i = h.length; n < i; ++n)
        (a = h[n]), (r = e ? 'hover' + a.charAt(0).toUpperCase() + a.slice(1) : a), (c[a] = tt([u[r], l[r], d[r]], f));
      return c;
    },
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (a.backgroundColor = tt([i.hoverBackgroundColor, e.hoverBackgroundColor, r(a.backgroundColor)], void 0, n)),
        (a.borderColor = tt([i.hoverBorderColor, e.hoverBorderColor, r(a.borderColor)], void 0, n)),
        (a.borderWidth = tt([i.hoverBorderWidth, e.hoverBorderWidth, a.borderWidth], void 0, n));
    },
    ...
    _setDatasetHoverStyle: function () {
      ...
      if (o) {
        for (
          r = o._model, a = this._resolveDatasetElementOptions(o, !0), t = 0, e = (i = Object.keys(a)).length;
          t < e;
          ++t
        )
          (s[(n = i[t])] = r[n]), (r[n] = a[n]);
        ...
        (function (t, e, n, i) {
          ...
          for (
            i &&
              ...
              ot(t, n),
              (n.endAngle = r),
              n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += rt), n.fullCircles--)),
              t.beginPath(),
            ...
            t.stroke();
          for (
            t.beginPath(), t.arc(n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + rt), a = 0;
            a < n.fullCircles;
            ++a
          )
            t.stroke();
  ...
  Y._set('global', {
    elements: {
      arc: { backgroundColor: Y.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' }
    }
  });
  var lt = X.extend({
      _type: 'arc',
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip ||
                ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : B.canvas.lineTo(r, e._view, n), (d = t));
  ...
  function bt(t) {
    ...
    return (
      vt(t)
        ? ((r = t.width / 2), (e = t.x - r), (n = t.x + r), (i = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base)))
        : ((r = t.height / 2), (e = Math.min(t.x, t.base)), (n = Math.max(t.x, t.base)), (i = t.y - r), (a = t.y + r)),
    ...
    var i,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          n = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = yt(e, 'left', 'right')) : t.base < t.y && (e = yt(e, 'bottom', 'top')),
            (n[e] = !0),
            n)
          : n;
      })(t);
  ...
  Y._set('global', {
    elements: { rectangle: { backgroundColor: pt, borderColor: pt, borderSkipped: 'bottom', borderWidth: 0 } }
  });
  var wt = X.extend({
      _type: 'rectangle',
      draw: function () {
      ...
      getCenterPoint: function () {
        var t,
          e,
          n = this._view;
        return vt(n) ? ((t = n.x), (e = (n.y + n.base) / 2)) : ((t = (n.x + n.base) / 2), (e = n.y)), { x: t, y: e };
      },
      getArea: function () {
        var t = this._view;
  ...
  function Ot(t, e, n) {
    var i,
      ...
      l = B.isNullOrUndef(r)
        ...
        : -1;
    return (
      B.isNullOrUndef(r) ? ((i = l * n.categoryPercentage), (a = n.barPercentage)) : ((i = r * o), (a = 1)),
  ...
  Y._set('bar', {
    ...
    Y._set('global', { datasets: { bar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
  var At = at.extend({
      ...
      calculateBarValuePixels: function (t, e, n) {
        ...
        return (
          ...
          void 0 !== p && Math.abs(l) < p && ((l = p), (s = (x >= 0 && !c) || (x < 0 && c) ? o - p : o + p)),
      ...
      _resolveDataElementOptions: function () {
        ...
        return (
          ...
          (e.categoryPercentage = Tt(n.categoryPercentage, e.categoryPercentage)),
  ...
  var Lt = at.extend({
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.backgroundColor = Ft(n.hoverBackgroundColor, i(n.backgroundColor))),
      ...
      _resolveDataElementOptions: function (t, e) {
        ...
        return (
          ...
          (s.radius = It([r.radius, o.r, n._config.radius, i.options.elements.point.radius], l, e)),
          s
        );
      }
    }),
  ...
  Y._set('horizontalBar', {
    ...
    Y._set('global', { datasets: { horizontalBar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
  var Et = At.extend({
      _getValueScaleId: function () {
        return this.getMeta().xAxisID;
      },
  ...
  function Gt(t) {
    var e, n, i, a;
    return (
      B.isObject(t) ? ((e = t.top), (n = t.right), (i = t.bottom), (a = t.left)) : (e = n = i = a = t),
  ...
  var qt = at.extend({
      ...
      updateBezierControlPoints: function () {
        ...
        if (
          ...
          for (t = 0, e = l.length; t < e; ++t)
            (n = l[t]._model),
              (i = B.splineCurve(B.previousItem(l, t)._model, n, B.nextItem(l, t)._model, o.tension)),
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.backgroundColor = Vt(n.hoverBackgroundColor, i(n.backgroundColor))),
  ...
  var Xt = zt,
    Kt = B.valueOrDefault;
  Y._set('radar', { spanGaps: !1, scale: { type: 'radialLinear' }, elements: { line: { fill: 'start', tension: 0 } } });
  var Jt = at.extend({
    datasetElementType: kt.Line,
    dataElementType: kt.Point,
    linkScales: B.noop,
    ...
    updateBezierControlPoints: function () {
      ...
      for (
        ...
        (n = o[t]._model),
          (i = B.splineCurve(B.previousItem(o, t, !0)._model, n, B.nextItem(o, t, !0)._model, n.tension)),
  ...
  function he(t, e, n) {
    var i,
      ...
      o = t.maxPadding;
    if (
      (n.size && (t[n.pos] -= n.size), (n.size = n.horizontal ? r.height : r.width), (t[n.pos] += n.size), r.getPadding)
    ) {
      var s = r.getPadding();
  ...
  function fe(t, e, n) {
    ...
    for (i = 0, a = t.length; i < a; ++i)
      (o = (r = t[i]).box).update(r.width || e.w, r.height || e.h, ce(r.horizontal, e)),
          ...
          var i = t.options.layout || {},
            ...
            s = (function (t) {
              var e = (function (t) {
                  ...
                  for (e = 0, n = (t || []).length; e < n; ++e)
                    (i = t[e]),
                      a.push({ index: e, box: i, pos: i.position, horizontal: i.isHorizontal(), weight: i.weight });
                  return a;
                })(t),
                n = ue(le(e, 'left'), !0),
                i = ue(le(e, 'right')),
            ...
            h = se({ maxPadding: se({}, a), w: r, h: o, x: a.left, y: a.top }, a);
          !(function (t, e) {
            var n, i, a;
            for (n = 0, i = t.length; n < i; ++n)
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === n.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = B.clone(Y.global.plugins[e])), n.push(t), i.push({ plugin: t, options: a || {} }));
            }
          }),
          (e.descriptors = i),
          (e.id = this._cacheId),
  ...
  var Ue = X.extend({
        ...
        if (m.length) {
          ...
          c.filter &&
            ...
            (y = (function (t, e) {
              ...
              return (
                (n.font = B.fontString(u, e._titleFontStyle, e._titleFontFamily)),
                B.each(e.title, f),
                ...
                (c = 0),
                (n.font = B.fontString(h, e._footerFontStyle, e._footerFontFamily)),
                B.each(e.footer, f),
            ...
            (b = (function (t, e, n, i) {
              ...
              return (
                'right' === u
                  ? (a -= e.width)
                  : 'center' === u &&
                    ((a -= e.width / 2) + e.width > i.width && (a = i.width - e.width), a < 0 && (a = 0)),
      ...
      handleEvent: function (t) {
        ...
        return (
          ...
          'mouseout' === t.type
            ? (n._active = [])
            : ((n._active = n._chart.getElementsAtEventForMode(t, i.mode, i)), i.reverse && n._active.reverse()),
      ...
      merger: function (t, e, n, i) {
        if ('xAxes' === t || 'yAxes' === t) {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = n[t][a]),
              (r = Ze(o.type, 'xAxes' === t ? 'category' : 'linear')),
  ...
  B.extend(en.prototype, {
    ...
    draw: function (t) {
      ...
      if (
        ...
        i.transition(t),
        !(i.width <= 0 || i.height <= 0) && !1 !== Re.notify(i, 'beforeDraw', [t]))
      ) {
    ...
    destroy: function () {
      ...
      i && (n.unbindEvents(), B.canvas.clear(n), Le.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
        Re.notify(n, 'destroy'),
    ...
    initToolTip: function () {
      var t = this;
      t.tooltip = new qe({ _chart: t, _chartInstance: t, _data: t.data, _options: t.options.tooltips }, t);
    },
    bindEvents: function () {
      var t = this,
        e = (t._listeners = {}),
    ...
    eventHandler: function (t) {
      ...
      if (!1 !== Re.notify(e, 'beforeEvent', [t])) {
        ...
        return (
          a
            ? e.render(a)
            : i && !e.animating && (e.stop(), e.render({ duration: e.options.hover.animationDuration, lazy: !0 })),
          (e._bufferedRender = !1),
      ...
      if (
        ...
        if (ln(s))
          for (r = 0, o = s.length; r < o; ++r)
            (g = s[r]), un(g) || ln(g) || ((c = B.measureText(t, d.data, d.gc, c, g)), (f += h));
  ...
  function mn(t) {
    var e, n;
    return t.display
      ? ((e = B.options._parseFont(t)), (n = B.options.toPadding(t.padding)), e.lineHeight + n.height)
      : 0;
  }
  function pn(t, e) {
    return B.extend(
  ...
  var xn = X.extend({
    ...
    afterBuildTicks: function (t) {
      ...
      return ln(t) && t.length
        ...
        : ((e.ticks = B.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks), t);
    },
    ...
    fit: function () {
      ...
      t.handleMargins(),
        u
          ? ((t.width = t._length = n.width - t.margins.left - t.margins.right), (t.height = e.height))
          : ((t.width = e.width), (t.height = t._length = n.height - t.margins.top - t.margins.bottom));
    },
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = fn(t.ctx, vn(t.options.ticks), t.getTicks(), t.longestTextCache)),
    ...
    _computeGridLineItems: function (t) {
      ...
      for (
        'top' === w
          ? ((e = F(b.bottom)), (s = b.bottom - C), (u = e - O), (h = F(t.top) + O), (f = t.bottom))
          : 'bottom' === w
          ? ((e = F(b.top)), (h = t.top), (f = F(t.bottom) - O), (s = e + O), (u = b.top + C))
          : 'left' === w
          ? ((e = F(b.right)), (o = b.right - C), (l = e - O), (d = F(t.left) + O), (c = t.right))
          : ((e = F(b.left)), (d = t.left), (c = F(t.right) - O), (o = e + O), (l = b.left + C)),
          n = 0;
        n < D;
        ++n
      )
      ...
      for (
        ...
        (i = (n = b[t]).label),
          un(i) ||
            ...
            (d = ln(i) ? i.length : 1),
            v
              ? ((a = s), (h = 'top' === m ? ((w ? 1 : 0.5) - d) * u : (w ? 0 : 0.5) * u))
              : ((r = s), (h = ((1 - d) * u) / 2)),
            k.push({ x: a, y: r, rotation: w, label: i, font: l, textOffset: h, textAlign: o }));
      return k;
    },
      ...
      if (n.display) {
        ...
        if (h) {
          var f,
            ...
            y = c.borderValue;
          e.isHorizontal()
            ? ((f = d(u, e.left, v) - v / 2), (g = d(u, e.right, b) + b / 2), (m = p = y))
            : ((m = d(u, e.top, v) - v / 2), (p = d(u, e.bottom, b) + b / 2), (f = g = y)),
            (l.lineWidth = h),
    ...
    _drawTitle: function () {
      ...
      if (i.display) {
        var a,
          ...
          h = 0;
        if (t.isHorizontal())
          (a = t.left + t.width / 2), (r = 'bottom' === d ? t.bottom - u - l.bottom : t.top + u + l.top);
        else {
          var c = 'left' === d;
    ...
    kn = _n.extend({
      ...
      _configure: function () {
        ...
        _n.prototype._configure.call(t),
          ...
          n && ((t._startValue = t.minIndex - (e ? 0.5 : 0)), (t._valueRange = Math.max(n.length - (e ? 0 : 1), 1)));
      },
  ...
  var Cn = _n.extend({
      ...
      buildTicks: function () {
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = B.niceNum((r * m) / u / l) * l),
              s || Dn(c)
              ...
              (r = (a - i) / m),
              (r = B.almostEquals(r, Math.round(r), m / 1e3) ? Math.round(r) : Math.ceil(r)),
              (i = Math.round(i * n) / n),
              (a = Math.round(a * n) / n),
              o.push(Dn(d) ? i : d);
      ...
      _configure: function () {
        ...
        _n.prototype._configure.call(e),
          e.options.offset && n.length && ((i -= t = (a - i) / Math.max(n.length - 1, 1) / 2), (a += t)),
          (e._startValue = i),
          (e._endValue = a),
          (e._valueRange = a - i);
      }
  ...
  var An = Cn.extend({
      ...
      _computeTickLimit: function () {
        ...
        return this.isHorizontal()
          ...
          : ((t = B.options._parseFont(this.options.ticks)), Math.ceil(this.height / t.lineHeight));
      },
  ...
  var Wn = _n.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Nn(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(Ln(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(Ln(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(Ln(t.max)) - 1)),
          null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(Ln(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
          ...
          a = (t.ticks = (function (t, e) {
            ...
            0 === r
              ? ((n = Math.floor(Ln(e.minNotZero))),
                ...
                a.push(r),
                (r = i * Math.pow(10, n)))
              : ((n = Math.floor(Ln(r))), (i = Math.floor(r / Math.pow(10, n))));
      ...
      _configure: function () {
        ...
        _n.prototype._configure.call(t),
          0 === e &&
            ...
            (n = In(t.options.ticks.fontSize, Y.global.defaultFontSize) / t._length)),
          (t._startValue = Ln(e)),
          (t._valueOffset = n),
      ...
      getPixelForValue: function (t) {
        var e = this,
          n = 0;
        return (
          (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (Ln(t) - e._startValue) / e._valueRange + e._valueOffset),
  ...
  function Gn(t, e, n, i) {
    var a,
      r,
      o = n.y + i / 2;
    if (B.isArray(e)) for (a = 0, r = e.length; a < r; ++a) t.fillText(e[a], n.x, o), (o += i);
          ...
          for (
            a.save(),
              ...
              a.setLineDash &&
                ...
                (a.lineDashOffset = Vn([s.borderDashOffset, o.borderDashOffset, 0]))),
  ...
  function li(t, e) {
    ...
    return (
      ...
      B.isFinite(o) || (o = 'string' == typeof r ? n.parse(o, r) : n.parse(o)),
      null !== o ? +o : (a || 'function' != typeof r || ((o = r(e)), B.isFinite(o) || (o = n.parse(o))), o)
    );
  }
  function ui(t, e) {
  ...
  function di(t, e, n, i) {
    ...
    for (a = ii.indexOf(t); a < s - 1; ++a)
      if (((o = (r = ni[ii[a]]).steps ? r.steps : ei), r.common && Math.ceil((n - e) / (o * r.size)) <= i))
        return ii[a];
    return ii[s - 1];
  }
  function hi(t, e, n) {
  ...
  var ci = _n.extend({
      ...
      determineDataLimits: function () {
        ...
        p.length && ((c = Math.min(c, p[0])), (f = Math.max(f, p[p.length - 1]))),
          g.length &&
            ((g =
              n > 1
                ? (function (t) {
          ...
          (i._offsets = (function (t, e, n, i, a) {
            ...
            return (
              a.offset &&
                e.length &&
                ((r = si(t, 'time', e[0], 'pos')),
                (s = 1 === e.length ? 1 - r : (si(t, 'time', e[1], 'pos') - r) / 2),
                (o = si(t, 'time', e[e.length - 1], 'pos')),
                (l = 1 === e.length ? o : (o - si(t, 'time', e[e.length - 2], 'pos')) / 2)),
  ...
  ci._defaults = fi;
  var gi = { category: kn, linear: An, logarithmic: Wn, radialLinear: $n, time: ci },
    mi = e(function (e, n) {
      e.exports = (function () {
        var n, i;
        function a() {
              ...
              (H[e] =
                ...
                (function (t) {
                  ...
                  for (e = 0, n = a.length; e < n; e++)
                    B[a[e]]
                      ? (a[e] = B[a[e]])
                      : (a[e] = (i = a[e]).match(/\[[\s\S]/) ? i.replace(/^\[|\]$/g, '') : i.replace(/\\/g, ''));
                  return function (e) {
                    var i,
                      r = '';
        ...
        function ht(t, e) {
          return h(ut, t)
            ...
            : new RegExp(
                ct(
                  t.replace('\\', '').replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, e, n, i, a) {
                    return e || n || i || a;
                  })
                )
              );
        ...
        function Ft(t, e, n) {
          t.isValid() &&
            ...
            ('FullYear' === e && Ct(t.year()) && 1 === t.month() && 29 === t.date()
              ? t._d['set' + (t._isUTC ? 'UTC' : '') + e](n, t.month(), It(n, t.month()))
        ...
        function Bt(t, e, n, i, a, r, o) {
          ...
          return (
            t < 100 && t >= 0
              ? ((s = new Date(t + 400, e, n, i, a, r, o)), isFinite(s.getFullYear()) && s.setFullYear(t))
        ...
        function Gt(t, e, n, i, a) {
          ...
          return (
            s <= 0 ? (o = Dt((r = t - 1)) + s) : s > Dt(t) ? ((r = t + 1), (o = s - Dt(t))) : ((r = t), (o = s)),
            { year: r, dayOfYear: o }
          );
        }
        function qt(t, e, n) {
            ...
            n &&
              ...
              ((e =
                n[bt] < 0 || n[bt] > 11
                  ...
                  ? yt
                  : n[xt] < 0 || n[xt] > 24 || (24 === n[xt] && (0 !== n[_t] || 0 !== n[wt] || 0 !== n[kt]))
                  ? xt
                  : n[_t] < 0 || n[_t] > 59
                  ? _t
                  : n[wt] < 0 || n[wt] > 59
                ...
                t._w &&
                  ...
                  (function (t) {
                    ...
                    i < 1 || i > Zt(n, r, o)
                      ...
                      : ((s = Gt(n, i, a, r, o)), (t._a[vt] = s.year), (t._dayOfYear = s.dayOfYear));
                  })(t),
                null != t._dayOfYear &&
                  ((o = be(t._a[vt], i[vt])),
                  (t._dayOfYear > Dt(o) || 0 === t._dayOfYear) && (g(t)._overflowDayOfYear = !0),
        ...
        function Oe(t) {
          ...
          if (l) {
            var u =
              ...
              (r = l[6]),
              (o = l[7]),
              (s = [Pe(e), Nt.indexOf(n), parseInt(i, 10), parseInt(a, 10), parseInt(r, 10)]),
          ...
          if (t._f !== a.ISO_8601)
            if (t._f !== a.RFC_2822) {
              ...
              var e,
                ...
                l = s.length,
                u = 0;
              for (i = G(t._f, t._locale).match(E) || [], e = 0; e < i.length; e++)
                (r = i[e]),
                  (n = (s.match(ht(r, t)) || [])[0]) &&
                    ((o = s.substr(0, s.indexOf(n))).length > 0 && g(t).unusedInput.push(o),
                    (s = s.slice(s.indexOf(n) + n.length)),
                    (u += n.length)),
                  B[r]
                    ? (n ? (g(t).empty = !1) : g(t).unusedTokens.push(r), pt(r, n, t))
                    : t._strict && !n && g(t).unusedTokens.push(r);
              (g(t).charsLeftOver = l - u),
                s.length > 0 && g(t).unusedInput.push(s),
                t._a[xt] <= 12 && !0 === g(t).bigHour && t._a[xt] > 0 && (g(t).bigHour = void 0),
                ...
                (t._a[xt] = (function (t, e, n) {
                  ...
                  return null == n
                    ...
                    ? t.meridiemHour(e, n)
                    : null != t.isPM
                    ? ((i = t.isPM(n)) && e < 12 && (e += 12), i || 12 !== e || (e = 0), e)
                    : e;
                                ...
                                null === e
                                  ? (De(t),
                                    !1 === t._isValid &&
                                      (delete t._isValid,
                                      Oe(t),
                                      !1 === t._isValid && (delete t._isValid, a.createFromInputFallback(t))))
                                  : (t._d = new Date(+e[1]));
                              })(t)
                            : r(e)
        ...
        function Ie(t, e, n, i, a) {
          ...
          return (
            ...
            (l._f = e),
            (l._strict = i),
            (s = new x(ve(Fe(l))))._nextDay && (s.add(1, 'd'), (s._nextDay = void 0)),
            s
          );
        }
        function Le(t, e, n, i) {
        ...
        function Ue(t, e) {
          ...
          return e._isUTC
            ? ((n = e.clone()),
              (i = (_(t) || u(t) ? t.valueOf() : Le(t).valueOf()) - n.valueOf()),
                ...
                (a =
                  r.isValid() && o.isValid()
                    ? ((o = Ue(o, r)),
                      r.isBefore(o)
                        ? (s = Je(r, o))
                        : (((s = Je(o, r)).milliseconds = -s.milliseconds), (s.months = -s.months)),
                      s)
        ...
        (Mn.add = en),
          ...
          (Mn.isBetween = function (t, e, n, i) {
            ...
            return (
              ...
              ('(' === (i = i || '()')[0] ? this.isAfter(a, n) : !this.isBefore(a, n)) &&
          ...
          (Mn.isSame = function (t, e) {
            ...
            return (
              ...
              ('millisecond' === (e = R(e) || 'millisecond')
                ...
                : ((n = i.valueOf()), this.clone().startOf(e).valueOf() <= n && n <= this.clone().endOf(e).valueOf()))
            );
          }),
          ...
          (Mn.toISOString = function (t) {
            ...
            return n.year() < 0 || n.year() > 9999
              ? U(n, e ? 'YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYYYY-MM-DD[T]HH:mm:ss.SSSZ')
              : O(Date.prototype.toISOString)
              ? e
                ? this.toDate().toISOString()
                : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace('Z', U(n, 'Z'))
              : U(n, e ? 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYY-MM-DD[T]HH:mm:ss.SSSZ');
          }),
          (Mn.inspect = function () {
          ...
          (Mn.months = D('months accessor is deprecated. Use month instead', zt)),
        ...
        function Tn(t, e, n, i) {
          'boolean' == typeof t
            ...
            : ((n = e = t), (t = !1), l(e) && ((n = e), (e = void 0)), (e = e || ''));
          var a,
            r = pe(),
            o = t ? r._week.dow : 0;
        ...
        (Dn.calendar = function (t, e, n) {
          ...
          (Dn.months = function (t, e) {
            return t
              ? r(this._months)
                ...
                : this._months[(this._months.isFormat || Lt).test(e) ? 'format' : 'standalone'][t.month()]
              : r(this._months)
              ? this._months
          ...
          (Dn.monthsShort = function (t, e) {
            return t
              ? r(this._monthsShort)
                ...
                : this._monthsShort[Lt.test(e) ? 'format' : 'standalone'][t.month()]
              : r(this._monthsShort)
              ? this._monthsShort
          ...
          (Dn.monthsRegex = function (t) {
            return this._monthsParseExact
              ? (h(this, '_monthsRegex') || Ht.call(this), t ? this._monthsStrictRegex : this._monthsRegex)
              : (h(this, '_monthsRegex') || (this._monthsRegex = Vt),
                this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
          }),
          (Dn.monthsShortRegex = function (t) {
            return this._monthsParseExact
              ? (h(this, '_monthsRegex') || Ht.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex)
            ...
            for (
              ...
              if (
                ...
                this._weekdaysParse[i] ||
                  ((r = '^' + this.weekdays(a, '') + '|^' + this.weekdaysShort(a, '') + '|^' + this.weekdaysMin(a, '')),
          ...
          (Dn.weekdaysRegex = function (t) {
            return this._weekdaysParseExact
              ? (h(this, '_weekdaysRegex') || ie.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex)
          ...
          (Dn.weekdaysShortRegex = function (t) {
            return this._weekdaysParseExact
              ...
              : (h(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = ee),
                this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
          }),
          (Dn.weekdaysMinRegex = function (t) {
            return this._weekdaysParseExact
              ? (h(this, '_weekdaysRegex') || ie.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
          ...
          (a.lang = D('moment.lang is deprecated. Use moment.locale instead.', ge)),
          (a.langData = D('moment.langData is deprecated. Use moment.localeData instead.', pe));
        var On = Math.abs;
        function An(t, e, n, i) {
          var a = Xe(e, n);
          return (
        ...
        return (
          ...
          (ri.as = function (t) {
            ...
            if ('month' === (t = R(t)) || 'quarter' === t || 'year' === t)
              switch (((e = this._days + i / 864e5), (n = this._months + In(e)), t)) {
                case 'month':
                  return n;
                case 'quarter':
                  return n / 3;
          ...
          (a.updateLocale = function (t, e) {
            if (null != e) {
              ...
              null != de[t] &&
                (null != de[t].parentLocale ? (de[t] = de[t].parentLocale) : null != de[t] && delete de[t]);
            return de[t];
          }),
          (a.locales = function () {
            return C(de);
  ...
  on._date.override(
    'function' == typeof mi
      ? {
          ...
          parse: function (t, e) {
            return (
              'string' == typeof t && 'string' == typeof e ? (t = mi(t, e)) : t instanceof mi || (t = mi(t)),
  ...
  function ki(t, e, n, i, a) {
    ...
    if (i && a) {
      ...
      if (void 0 === n[0].angle)
        ...
        for (
          o = n[0].cx, s = n[0].cy, l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)), r = a - 1;
          r > 0;
          --r
        )
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c
          ...
          : b && y && (m ? (h && p.push(u), c && v.push(d)) : (ki(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) &&
              ...
              (r = { visible: t.isDatasetVisible(i), fill: bi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r);
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            o &&
              s &&
              r.length &&
              (B.canvas.clipArea(u, t.chartArea), Mi(u, r, o, a, s, i._loop), B.canvas.unclipArea(u)));
      }
    },
  ...
  var Oi = X.extend({
    ...
    fit: function () {
      var t = this,
        ...
        u = t.isHorizontal();
      if (
        (u ? ((l.width = t.maxWidth), (l.height = i ? 10 : 0)) : ((l.width = i ? 10 : 0), (l.height = t.maxHeight)), i)
      ) {
        if (((a.font = r.string), u)) {
          ...
          B.each(t.legendItems, function (t, e) {
            var i = Ti(n, o) + o / 2 + a.measureText(t.text).width;
            e > 0 && v + o + 2 * c > l.height && ((m += p + n.padding), f.push(p), g.push(v), (p = 0), (v = 0)),
              (p = Math.max(p, i)),
              (v += o + c),
              (s[e] = { left: 0, top: 0, width: i, height: o });
          }),
          ...
          h.setWidth(t.minSize.width),
            y
              ...
              : i > 0 &&
                ...
                ((_ = d.x = _ + t.columnWidths[d.line] + n.padding), d.line++, (w = d.y = t.top + b(o, s[d.line])));
          var k = h.x(_);
          !(function (t, e, i) {
            if (!(isNaN(p) || p <= 0)) {
              c.save();
            ...
            (function (t, e, n, i) {
              ...
              c.fillText(n.text, r, o),
                n.hidden && (c.beginPath(), (c.lineWidth = 2), c.moveTo(r, o), c.lineTo(h.xPlus(r, i), o), c.stroke());
            })(k, w, e, f),
  ...
  var Fi = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          n = t.legend;
        e
          ? (B.mergeIf(e, Y.global.legend), n ? (pe.configure(t, n, e), (n.options = e)) : Ai(t, e))
  ...
  var Li = X.extend({
    ...
    fit: function () {
      var t,
        ...
        a = e.isHorizontal();
      n.display
        ? ((t = (B.isArray(n.text) ? n.text.length : 1) * B.options._parseFont(n).lineHeight + 2 * n.padding),
    ...
    draw: function () {
      ...
      if (n.display) {
        var i,
          ...
          c = t.bottom,
          f = t.right;
        (e.fillStyle = B.valueOrDefault(n.fontColor, Y.global.defaultFontColor)),
          (e.font = o.string),
          t.isHorizontal()
          ...
          (e.textBaseline = 'middle');
        var g = n.text;
        if (B.isArray(g)) for (var m = 0, p = 0; p < g.length; ++p) e.fillText(g[p], 0, m, i), (m += s);
    ...
    zi = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          n = t.titleBlock;
        e
          ? (B.mergeIf(e, Y.global.title), n ? (pe.configure(t, n, e), (n.options = e)) : Ri(t, e))
    ...
    (B.where = function (t, e) {
              ...
              (B.almostEquals(i.deltaK, 0, this.EPSILON)
                ...
                : ((r = i.mK / i.deltaK),
                  ...
                  (l = Math.pow(r, 2) + Math.pow(o, 2)) <= 9 ||
                    ((s = 3 / Math.sqrt(l)), (i.mK = r * s * i.deltaK), (a.mK = o * s * i.deltaK))));
        for (e = 0; e < h; ++e)
          (i = d[e]).model.skip ||
            ((n = e > 0 ? d[e - 1] : null),
            (a = e < h - 1 ? d[e + 1] : null),
      ...
      (B.niceNum = function (t, e) {
        var n = Math.floor(B.log10(t)),
          i = t / Math.pow(10, n);
        return (
          (e ? (i < 1.5 ? 1 : i < 3 ? 2 : i < 7 ? 5 : 10) : i <= 1 ? 1 : i <= 2 ? 2 : i <= 5 ? 5 : 10) * Math.pow(10, n)
        );
      }),
      (B.requestAnimFrame =
        'undefined' == typeof window
      ...
      (B.retinaScale = function (t, e) {
        ...
        if (1 !== n) {
          ...
          (i.height = a * n),
            (i.width = r * n),
            t.ctx.scale(n, n),
            i.style.height || i.style.width || ((i.style.height = a + 'px'), (i.style.width = r + 'px'));
        }
      }),
        ...
        for (o = 0; o < c; o++)
          if (null != (u = n[o]) && !0 !== B.isArray(u)) h = B.measureText(t, a, r, h, u);
            ...
            for (s = 0, l = u.length; s < l; s++)
              null == (d = u[s]) || B.isArray(d) || (h = B.measureText(t, a, r, h, d));
        var f = r.length / 2;
        if (f > n.length) {
  ...
  return (
    ...
    nn.helpers.each(['Bar', 'Bubble', 'Doughnut', 'Line', 'PolarArea', 'Radar', 'Scatter'], function (t) {
      nn[t] = function (e, n) {
        return new nn(e, nn.helpers.merge(n || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) }));
      };
    }),
    Vi
  );
