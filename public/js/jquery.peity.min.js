...
!(function (t, i, e, n) {
  ...
  (h.draw = function () {
    ...
    (h.prepare = function (t, i) {
      return (
        this.$svg || this.$el.hide().after((this.$svg = s('svg', { class: 'peity' }))),
      ...
      for (l = 0; l < p; l++) {
        ...
        if (0 != j) {
          if (1 == j)
            ...
            v ? (S = S.concat(w(M, v), 'A', v, v, 0, j > 0.5 ? 1 : 0, 0, w(x, v))) : S.push(u, d),
              (x += $),
              (k = s('path', { d: S.join(' '), 'data-value': $ }));
          }
    ...
    a.register('bar', { delimiter: ',', fill: ['#4D89F9'], height: 16, min: 0, padding: 0.1, width: 32 }, function (t) {
      for (
        ...
        o ? (w < 0 ? (k = d(e.min(a, 0))) : ($ = d(e.max(r, 0)))) : (v = 1),
          0 == (v = $ - k) && ((v = 1), a > 0 && o && k--),
          h.append(s('rect', { 'data-value': w, fill: c.call(this, w, g, i), x: m, y: k, width: y, height: v }));
      }
    });
