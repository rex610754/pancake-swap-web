!(function (t, e, n, r, o) {
  if ('customElements' in n) o();
    ...
    a.then(o);
    var i =
        n.WEB_COMPONENTS_POLYFILL || '//cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/2.0.2/webcomponents-bundle.js',
                    ...
                    value: function (t, e) {
                      ...
                      return (
                        'solid' === e
                          ...
                          : 'logo' === e && (n = this.cdnUrl + '/logos/bxl-' + t + '.svg'),
                        (n && b[n]) ||
                          (b[n] = new Promise(function (t, e) {
                            var r = new XMLHttpRequest();
                            r.addEventListener('load', function () {
                              this.status < 200 || this.status >= 300
                                ? e(new Error(this.status + ' ' + this.responseText))
                                : t(this.responseText);
                            }),
                              (r.onerror = e),
                              (r.onabort = e),
